...
\node[draw, shape = ellipse, text width=2cm, minimum height=0.8cm, thick, align=center] (C) at (2, -3) {5};
\node[draw, shape = ellipse, text width=2cm, minimum height=0.8cm, thick, align=center] (D) at (-4, -6) {4};
\node[draw, shape = rectangle, text width=3cm, minimum height=1.6cm, thick, align=center] (E) at (0, -6) {Début ou fin de partie ?};
\node[draw, shape = ellipse, text width=2cm, minimum height=0.8cm, thick, align=center] (F) at (-2, -9) {6};
\node[draw, shape = ellipse, text width=2cm, minimum height=0.8cm, thick, align=center] (G) at (2, -9) {5};
...
\draw[thick, -Stealth] (E) -- node[midway, right] {non} (G);
\end{tikzpicture}
}
...
\node[draw, shape = ellipse, text width=2cm, minimum height=0.8cm, thick, align=center] (E) at (0, -6) {Garder le comportement de la partie I};
\node[draw, shape = rectangle, text width=3cm, minimum height=1.6cm, thick, align=center] (F) at (4, -9) {Est-on face à l'ennemi ?};
\node[draw, shape = ellipse, text width=2cm, minimum height=0.8cm, thick, align=center] (G) at (4, -12) {2};
\node[draw, shape = ellipse, text width=2cm, minimum height=0.8cm, thick, align=center] (H) at (0, -12) {3};
...
\node[draw, shape = ellipse, text width=2cm, minimum height=0.8cm, thick, align=center] (B) at (2, -3) {7};
\node[draw, shape = rectangle, text width=3cm, minimum height=1.6cm, thick, align=center] (C) at (-2, -3) {Comportement de la partie II == 2 ?};
\node[draw, shape = ellipse, text width=2cm, minimum height=0.8cm, thick, align=center] (D) at (-4, -6) {Garder le comportement de la partie II};
\node[draw, shape = rectangle, text width=3cm, minimum height=1.6cm, thick, align=center] (E) at (0, -6) {Suis-je bloqué ?};
\node[draw, shape = ellipse, text width=2cm, minimum height=0.8cm, thick, align=center] (F) at (0, -9) {Arrière};
\draw[thick, -Stealth] (A) -- node[midway, right] {oui} (B);
\draw[thick, -Stealth] (A) -- node[midway, left] {non} (C);
